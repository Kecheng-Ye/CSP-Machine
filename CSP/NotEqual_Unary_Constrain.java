...
public class NotEqual_Unary_Constrain extends Constrain{
	Variable variable;
	Object value;
	
	public NotEqual_Unary_Constrain(Variable variable,Object value) {
	...
	public String toString() {
		return "This is a Unary Not Equal Constrain for "+variable.Variable_name+" and it's value should not be "+value;
	}
