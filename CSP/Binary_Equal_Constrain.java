...
public class Binary_Equal_Constrain extends Constrain{
	Variable variable_1;
	Variable variable_2;
	
	public Binary_Equal_Constrain(Variable variable_1,Variable variable_2) {
	...
	public String toString() {
		return "This is Binary Not Equal Constrain which compares "+variable_1.Variable_name+" and "+variable_2.Variable_name;
	}
}
